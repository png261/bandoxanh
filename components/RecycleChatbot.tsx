...
export default function RecycleChatbot() {
  ...
  const [messages, setMessages] = useState<Message[]>([
    {
      role: 'assistant',
      content: 'Xin chào! 👋 Tôi là trợ lý AI về tái chế và bảo vệ môi trường. Bạn có thể hỏi tôi về cách phân loại rác, tái chế, hoặc bất kỳ câu hỏi nào về môi trường!'
    }
  ]);
        ...
        <div className="fixed bottom-24 right-6 z-50 w-96 h-[600px] bg-white dark:bg-gray-800 rounded-2xl shadow-2xl flex flex-col overflow-hidden border border-gray-200 dark:border-gray-700 transition-all duration-300">
          ...
          <div className="bg-gradient-to-r from-green-500 to-green-600 text-white p-4 flex items-center justify-between">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h3 className="font-bold text-lg">Trợ lý Tái chế</h3>
                <p className="text-xs opacity-90">Luôn sẵn sàng giúp đỡ bạn</p>
              </div>
            </div>
            <button
          ...
          <div className="p-4 bg-white dark:bg-gray-800 border-t border-gray-200 dark:border-gray-700">
            <div className="flex gap-2">
              <input
                ...
                placeholder="Hỏi về tái chế, phân loại rác..."
